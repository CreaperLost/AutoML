...
"""
fig, ax = plt.subplots()
plt.title('AUC Boxplot for MAR case when feature selection is excluded')
boxplots = list()
j=0
i=0
...
fig, ax = plt.subplots()
plt.title('AUC Difference for MAR case when feature selection is excluded')
boxplots = list()
j=0
i=0
...
#AUC Difference With feature selection.
...
"""
fig, ax = plt.subplots()
plt.title('AUC Boxplot for MAR case when feature selection is enforced')
boxplots = list()
j=0
i=0
#['MM','BI+MM','GAIN','BI+GAIN','MF','BI+MF','SOFT','BI+SOFT','PPCA','BI+PPCA']
...
fig, ax = plt.subplots()
plt.title('AUC difference for MAR case when feature selection is enforced')
boxplots = list()
j=0
i=0
